...
namespace TU {
  ...
  const char * const channel_trigger_sources[] = { "TR1", "TR2", "none", "INT" };

  const char * const reset_trigger_sources[] = { "RST1", "RST2", "none", "=HI2", "=LO2" };

  const char * const cv_sources[] = { "--", "CV1", "CV2", "CV3", "CV4" };
